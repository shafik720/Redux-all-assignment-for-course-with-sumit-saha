...
import { deleteBook } from '../../../../Redux/book/actionCreators';
import { edit } from '../../../../Redux/editBook/actionCreators';
...
const Card = ({book}) => {
    ...
    // --- editing a book
    const editBook = () => {
        dispatch(edit(true, name, author, thumbnail, price, rating, featured, id));
    }
    ...
    return (
        <div className="book-card">
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                ...
                {featured ? <span className="badge-success lws-Badge">featured</span> : <div></div>} 
                    
                    <div className="text-gray-500 space-x-2">
                        <button onClick={editBook} className="lws-edit">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round"
                                    d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                            </svg>
                        </button>
                        <button className="lws-delete" onClick={removeBook}>
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round"

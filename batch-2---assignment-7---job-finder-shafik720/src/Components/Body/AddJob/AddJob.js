...
import { addJobs, sortByDefault } from '../../../features/jobs/jobSlice';
            ...
            <div className="max-w-3xl mx-auto">
                <form className="space-y-6" onSubmit={handleAddJob}>
                    <div className="fieldContainer">
                        ...
                        <select id="lws-JobTitle" name="lwsJobTitle" required onChange={e => setTitle(e.target.value)} defaultValue=''>
                    ...
                    <div className="fieldContainer">
                        ...
                        <select id="lws-JobType" name="lwsJobType" required defaultValue='' onChange={e => setType(e.target.value)}>
                    ...
                    <div className="fieldContainer">
                        ...
                        <div className="flex border rounded-md shadow-sm border-slate-600">
                            ...
                            <input type="number" name="lwsJobSalary" id="lws-JobSalary" required className="!rounded-l-none !border-0"
                                placeholder="20,00,000" onChange={e => setSalary(e.target.value)} />
                        </div>
                    </div>
